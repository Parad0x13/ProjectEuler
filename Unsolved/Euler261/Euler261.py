...
import timeit
FindSquarePivotsTimer = timeit.Timer("FindSquarePivots()","from __main__ import FindSquarePivots")
...
print "Took %f seconds" % (FindSquarePivotsTimer.timeit(1))

#import cProfile
#cProfile.run('FindSquarePivots()')
